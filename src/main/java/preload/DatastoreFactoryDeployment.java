...
public class DatastoreFactoryDeployment {
...

    {
        ...
        try {
            ...
            replicationGroup1Nodes.add(new TAddress(InetAddress.getByName("127.0.0.1"), 10001));
            replicationGroup1Nodes.add(new TAddress(InetAddress.getByName("127.0.0.1"), 10002));
            replicationGroup1Nodes.add(new TAddress(InetAddress.getByName("127.0.0.1"), 10003));
            ...
            replicationGroup2Nodes.add(new TAddress(InetAddress.getByName("127.0.0.1"), 10004));
            replicationGroup2Nodes.add(new TAddress(InetAddress.getByName("127.0.0.1"), 10005));
            replicationGroup2Nodes.add(new TAddress(InetAddress.getByName("127.0.0.1"), 10006));
            ...
            replicationGroup3Nodes.add(new TAddress(InetAddress.getByName("127.0.0.1"), 10007));
            replicationGroup3Nodes.add(new TAddress(InetAddress.getByName("127.0.0.1"), 10008));
            replicationGroup3Nodes.add(new TAddress(InetAddress.getByName("127.0.0.1"), 10009));
